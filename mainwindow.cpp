    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->textBrowser->setText("Version 2\n");
    ui->textBrowser->append("Add: Automatically set system time\n");
    ui->textBrowser->append("Fix: Logout function");
